 ...
 */
/*****************************************************************************/
/* $Id: tdcbase.h,v 1.19 2017/11/14 18:04:16 trurl Exp $ */
...
#define TDC_QUTAG_CHANNELS   5   /**< Number of hardware input channels of quTAG (2a dev.) */
...
typedef enum {
  DEVTYPE_1A,                    /**< Type 1a - quTAU - no signal conditioning */
  DEVTYPE_1B,                    /**< Type 1b - quTAU 1b - 8 channel signal conditioning */
  DEVTYPE_1C,                    /**< Type 1c - quPSI - 3 channel signal conditioning */
  DEVTYPE_2A,                    /**< Type 2a - quTAG - 5 channel signal conditioning */
 ...
 *  the function isn't available for 1a devices. If it isn't present for the
 ...
 *                 <br> 1A:  Function not available, @ref TDC_OutOfRange is returned
 *                 <br> 1B:  1, 8, 16, 32, 64, 128
 *                 <br> 1C:  Ignored, divider is always 1024
 *                 <br> 2A:  1, 2, 4, 8
 ...
 *
 *  Reads back the input divider configuration of channel 0 if available; see
 ...
 *                  Must be positive for 2a devices.
 *  @return         Error code
 */
 ...
 *  @return         Error code
 */
TDC_API int TDC_CC TDC_setDeadTime( Int32 dTime );
 ...
 *  @return         Error code
 */
TDC_API int TDC_CC TDC_getDeadTime( Int32 * dTime );
